...
namespace SwissTimingDisplay
{
    ...
    public partial class SiriccoWindowWG : Window
    {
        ...
        public SiriccoWindowWG() : this(MainViewModel.SharedInstance, null)
        {
        }

        public SiriccoWindowWG(MainViewModel vm, MainWindow? mainWindow = null)
        {
            _vm = vm;
            ...
            // Fix these for actual Siricco WindGauge operation
            _vm.ShowSimulator = true;
